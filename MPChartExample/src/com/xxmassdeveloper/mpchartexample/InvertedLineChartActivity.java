...
public class InvertedLineChartActivity extends DemoBase implements
...
//        mSeekBarX.setOnSeekBarChangeListener(this);
        ...
        leftAxis.setEnabled(true);     //是否显示y坐标轴 及 对应的刻度竖线，默认是true
...
//    }
    ...
    private void setData(int count, float range) {
        ...
        set1.setCircleColor(getResources().getColor(R.color.circle_color));
        set1.setCircleColorHole(Color.WHITE);
        set1.setCircleHoleRadius(4);
        set1.setCircleRadius(5);
        set1.setFillColor(getResources().getColor(R.color.bg_color));
